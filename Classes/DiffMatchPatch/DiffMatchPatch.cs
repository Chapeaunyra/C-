...
namespace [nom namespace] {
  ...
  public class diff_match_patch {
    ...
    public float Diff_Timeout = 0; // 1.0f by default
    // Cost of an empty edit operation in terms of edit characters.
    public short Diff_EditCost = 4;
    // At what point is no match declared (0.0 = perfection, 1.0 = very loose).
    public float Match_Threshold = 0; // 0.5f by default
    ...
    private List<Diff> diff_compute(string text1, string text2, bool checklines, DateTime deadline) {
      ...
      return diff_bisect(text1, text2, deadline);
         ...
         * @return List of Diff objects.
         */
      public List<Diff> diff_lineMode(string text1, string text2, DateTime deadline) {
     ...
     * @param lineArray List of unique strings.
     */
    public void diff_charsToLines(ICollection<Diff> diffs, IList<string> lineArray) {
      StringBuilder text;
